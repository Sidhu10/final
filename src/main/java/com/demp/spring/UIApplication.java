...
public class UIApplication implements WebMvcConfigurer{
	...
	public void addViewControllers(ViewControllerRegistry registry) {
		...
		registry.addViewController("/homeOwner").setViewName("home");
	       registry.addViewController("/homeVett").setViewName("homeVet");
	       registry.addViewController("/homeVisitt").setViewName("homeVisit");
